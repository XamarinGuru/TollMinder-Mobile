...
namespace Tollminder.Touch.Helpers
{
    public class RoundedButtonManager
    {
        ...
        public static RoundedButton ButtonInitiaziler(string text = null, UIImage image = null, UIColor textColor = null,
                                               UIColor backgroundColor = null, int linesNumber = 0)
        {
            _roundedButton = new RoundedButton();
            return SetParameters(text, image, textColor, backgroundColor, linesNumber);
        }

        private static RoundedButton SetParameters(string text = null, UIImage image = null, UIColor textColor = null,
                                               UIColor backgroundColor = null, int linesNumber = 0)
        {
